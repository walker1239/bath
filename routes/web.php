...
Route::group(['middleware' => ['auth', 'check_invitation'], 'prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('companys', 'Admin\CompanysController');
    Route::post('companys_mass_destroy', ['uses' => 'Admin\CompanysController@massDestroy', 'as' => 'companys.mass_destroy']);
    Route::post('companys_restore/{id}', ['uses' => 'Admin\CompanysController@restore', 'as' => 'companys.restore']);
    Route::delete('companys_perma_del/{id}', ['uses' => 'Admin\CompanysController@perma_del', 'as' => 'companys.perma_del']);
